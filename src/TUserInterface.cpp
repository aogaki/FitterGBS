...
TUserInterface::TUserInterface() : TGMainFrame(gClient->GetRoot(), 100, 100)
{
  char buf[32];
  ...
  fTeh1->Connect("TextChanged(char*)", "TUserInterface", this, "DoText(char*)");
  fTeh2->Connect("TextChanged(char*)", "TUserInterface", this, "DoText(char*)");
  fTeh3->Connect("TextChanged(char*)", "TUserInterface", this, "DoText(char*)");

  fCheck1->Connect("Clicked()", "TUserInterface", this, "HandleButtons()");
  fCheck2->Connect("Clicked()", "TUserInterface", this, "HandleButtons()");
